#include "r_lineal.h"
#include "ui_r_lineal.h"

r_lineal::r_lineal(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::r_lineal)
{
    ui->setupUi(this);
    connect(ui->metodo,SIGNAL(clicked()),this,SLOT(metodos_8()));
    connect(ui->borrar,SIGNAL(clicked()),this,SLOT(borrar_8()));
